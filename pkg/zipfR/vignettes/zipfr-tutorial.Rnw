...
\setmarginsrb{30mm}{25mm}{30mm}{15mm}% left, top, right, bottom
...
proportion of OOV \emph{tokens} in larger samples, given our lexicon of 5,157
types. First, we generate a model-derived spectrum at the desired $N$. From
